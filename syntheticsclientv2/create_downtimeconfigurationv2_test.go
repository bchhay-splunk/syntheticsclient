...
var (
	createDowntimeConfigurationV2Body = `{"downtimeConfiguration":{"name":"dc test","description":"My super awesome test downtimeConfiguration","rule":"augment_data","testIds":[29976],"startTime":"2024-05-16T20:23:00.000Z","endTime":"2024-05-16T20:38:00.000Z"}}`
...
func TestCreateDowntimeConfigurationV2(t *testing.T) {
	...
	if !reflect.DeepEqual(resp.DowntimeConfiguration.Testcount, len(inputDowntimeConfigurationV2Data.DowntimeConfiguration.Testids)) {
		t.Errorf("returned \n\n%#v want \n\n%#v", resp.DowntimeConfiguration.Testcount, len(inputDowntimeConfigurationV2Data.DowntimeConfiguration.Testids))
	}
