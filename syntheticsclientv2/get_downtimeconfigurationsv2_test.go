...
func TestGetDowntimeConfigurationV2(t *testing.T) {
	...
	if !reflect.DeepEqual(resp.DowntimeConfiguration.Testcount, len(inputGetDowntimeConfigurationV2.DowntimeConfiguration.Testids)) {
		t.Errorf("returned \n\n%#v want \n\n%#v", resp.DowntimeConfiguration.Testcount, len(inputGetDowntimeConfigurationV2.DowntimeConfiguration.Testids))
	}
...
func TestGetDowntimeConfigurationsV2(t *testing.T) {
	...
	if !reflect.DeepEqual(resp.Downtimeconfigurations[0].Testcount, len(inputGetDowntimeConfigurationsV2.Downtimeconfigurations[0].Testids)) {
		t.Errorf("returned \n\n%#v want \n\n%#v", resp.Downtimeconfigurations[0].Testcount, len(inputGetDowntimeConfigurationsV2.Downtimeconfigurations[0].Testids))
	}
